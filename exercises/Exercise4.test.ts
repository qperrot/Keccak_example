...
describe("Exercise 4", function () {
    ...
    describe("Test exercise 4", function () {
        it("Should have the same hash as solidity keccak256(abi.encodePacked(uint256, address, uint8, uint8))", async function () {
            const { hash: hash } = await exerciseContract.call("exercise4", {
                a_uint256: uint256.bnToUint256(230), address: "0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266", b_uint8: uint256.bnToUint256(9), c_uint8: uint256.bnToUint256(3),
            });
            const solidityHash = ethers.utils.solidityKeccak256(
                ["uint256", "address", "uint8", "uint8"],
                [230, "0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266", 9, 3]
            );
